...
public class ShopListViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        txtShopPrice.setText("￥"+this.sysPetShops.get(position).getMoneys().toString());
            ...
            public void onClick(View view) {
                ...
                confirmDialog.setYesOnclickListener("确定", new ConfirmDialog.onYesOnclickListener() {
                    ...
                    public void onYesClick() {
                        ...
                        NetRequest request = new NetRequest(ApiConfig.API_BUY_SHOP,"post").addHeader("userId", App.getMember(ShopListViewAdapter.this.context).getMemberId()+"").addParam("shopId",sysPetShops.get(position).getPetShopId()+"");
