...
import com.example.petclient.base.adapter.PetTestAdapter;
...
import com.example.petclient.utils.http.entry.SysPetTestListData;

import java.util.ArrayList;
import java.util.List;

public class PetTestActivity extends BaseActivity {
    SwipeRefreshLayout Main_srLayoutNewsList;
    ListView all_list;
    NetClient netClient;
    List<SysPetTest> petTests;
    PetTestAdapter adapter;
    ListPageEvent listPageEvent;

    @Override
    protected int getLayoutId() {
        return R.layout.activity_pet_test;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PetTestAdapter(this,new ArrayList<SysPetTest>());
        ...
        NetRequest request = new NetRequest(ApiConfig.API_PET_TEST_LIST,"get").addHeader("userId", App.getMember(this).getMemberId()+"")
                .addParam("petId",petId+"");
        netClient.Request(request).Callback(new NetJsonCallBack<SysPetTestListData>(SysPetTestListData.class) {
            @Override
            public void success(SysPetTestListData data) {
                if(data.getState() == 0){
                    ...
                    PetTestActivity.this.petTests = data.getData();
            ...
            public void handler(Message msg) {
                ...
                if(msg.what == 0){
                    //显示
                    listPageEvent.isOver(petTests.size());
                    adapter.add(PetTestActivity.this.petTests);
                    adapter.notifyDataSetChanged();
                }else if(msg.what == 1){
                    ToastUtil.show(PetTestActivity.this,bundle.getString("message"));
                }else{
                    ToastUtil.show(PetTestActivity.this,bundle.getString("message"));
                }
        ...
        Main_srLayoutNewsList.setProgressBackgroundColorSchemeColor(ContextCompat.getColor(PetTestActivity.this,R.color.colorPrimaryDark));
