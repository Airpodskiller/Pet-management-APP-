...
import com.example.petclient.base.adapter.PetIllAdapter;
...
import com.example.petclient.utils.http.entry.SysPetIllListData;

import java.util.ArrayList;
import java.util.List;

public class PetIllActivity extends BaseActivity {

    SwipeRefreshLayout Main_srLayoutNewsList;
    ListView all_list;
    NetClient netClient;
    List<SysPetIll> petIlls;
    PetIllAdapter adapter;
    ListPageEvent listPageEvent;

    @Override
    protected int getLayoutId() {
        return R.layout.activity_pet_ill;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PetIllAdapter(this,new ArrayList<SysPetIll>());
        ...
        NetRequest request = new NetRequest(ApiConfig.API_PET_ILL_LIST,"get").addHeader("userId", App.getMember(this).getMemberId()+"")
                .addParam("petId",petId+"");
        netClient.Request(request).Callback(new NetJsonCallBack<SysPetIllListData>(SysPetIllListData.class) {
            @Override
            public void success(SysPetIllListData data) {
                if(data.getState() == 0){
                    ...
                    PetIllActivity.this.petIlls = data.getData();
            ...
            public void handler(Message msg) {
                ...
                if(msg.what == 0){
                    //显示
                    listPageEvent.isOver(petIlls.size());
                    adapter.add(PetIllActivity.this.petIlls);
                    adapter.notifyDataSetChanged();
                }else if(msg.what == 1){
                    ToastUtil.show(PetIllActivity.this,bundle.getString("message"));
                }else{
                    ToastUtil.show(PetIllActivity.this,bundle.getString("message"));
                }
        ...
        Main_srLayoutNewsList.setProgressBackgroundColorSchemeColor(ContextCompat.getColor(PetIllActivity.this,R.color.colorPrimaryDark));
