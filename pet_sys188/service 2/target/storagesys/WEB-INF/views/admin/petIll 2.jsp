    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <th width="100">宠物症状</th>
                <th width="100">治疗金额</th>
                <th width="100">状态</th>
...
<script type="text/javascript">
    var table = $('.table-sort').dataTable({
        ...
        "columns": [
            ...
            {
                "data": "petIllId", "render": function (data, type, full, meta) {
                    var opt = "";
                    if(full.isOver == 0){
                        opt += "<a title='治疗完成' href='javascript:;' onclick=\"confirmTest("+data+")\" class='ml-5' style='text-decoration:none'>治疗完成</a>";
                    }
                    return opt;
                }
            }
    ...
    function confirmTest(id) {
        layer.confirm('确认已完成治疗项目？',function(index){
            $.ajax({
                type: 'POST',
                url: '/admin/home/confirmIll',
                data:{
                    petIllId:id
                },
                dataType: 'json',
