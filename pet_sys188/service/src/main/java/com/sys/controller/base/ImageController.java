...
public class ImageController {
    ...
    static {
        String currentPath=ImageController.class.getResource("/").getPath();
        currentPath = currentPath.substring(0,currentPath.lastIndexOf("/service/"));
        String os = System.getProperty("os.name");
        if (os != null && os.toLowerCase().startsWith("windows")) {
            currentPath = currentPath.substring(1);
        }
        basePath = currentPath + "/service/upload/";
