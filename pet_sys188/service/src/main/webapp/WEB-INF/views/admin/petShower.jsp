...
<script type="text/javascript">
                ...
                }},
            {
                "data": "petShowerId", "render": function (data, type, full, meta) {
                    ...
                    if(full.isOver == 0){
                        ...
                        opt += "<a title='完成洗澡' href='javascript:;' onclick=\"okShower("+data+")\" class='ml-5' style='text-decoration:none'>完成洗澡</a>";
                    }
                    return opt;
                }
            }
    ...
    function okShower(id) {
        layer.confirm('确认完成洗澡？',function(index){
            var load = layer.load(1);
            $.ajax({
                type: 'POST',
                url: '/admin/home/okShower',
                data:{
                    petShowerId:id
                },
                dataType: 'json',
